...
mcp_save = ModelCheckpoint('C:/Users/atrone/cursorProjects/NBA-Betting/NBA-Machine-Learning-Sports-Betting/Models/Trained-Model-OU-' + current_time, save_best_only=True, monitor='val_loss', mode='min')
