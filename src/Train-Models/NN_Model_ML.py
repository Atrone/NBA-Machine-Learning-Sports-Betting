...
tensorboard = TensorBoard(log_dir='C:/Users/atrone/cursorProjects/NBA-Betting/NBA-Machine-Learning-Sports-Betting/Logs/' + current_time)
earlyStopping = EarlyStopping(monitor='val_loss', patience=10, verbose=0, mode='min')
mcp_save = ModelCheckpoint('C:/Users/atrone/cursorProjects/NBA-Betting/NBA-Machine-Learning-Sports-Betting/Models/Trained-Model-ML-' + current_time, save_best_only=True, monitor='val_loss', mode='min')
